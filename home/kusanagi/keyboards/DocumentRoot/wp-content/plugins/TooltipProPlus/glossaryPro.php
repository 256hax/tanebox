    ...
    public static function cmtt_prepareReplaceTemplate($title) {
        ...
        if ($highlightFirstOccuranceOnly && is_array($replacedTerms) && !empty($replacedTerms)) {
            foreach ($replacedTerms as $replacedTermTitle => $replacedTerm) {
                 ...
                 */
                $firstOnlyIncludingVariations = get_option('cmtt_firstOnlyIncludingVariations', false);
...
//            '_builtin' => false
    ...
    public static function outputACFTypesList($fieldName = 'cmtt_acf_parsed_field_types', $defaultSelected = array('text', 'wysiwyg')) {
        $content = '';
