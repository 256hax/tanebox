...
class CMTT_Glossary_Plus {
    ...
    public static function init() {
        ...
        add_filter('cmtt_glossaryItemTitle', array(__CLASS__, 'addCategory'), 22000, 2);
    ...
    public static function taxonomyIndexLinkField($tag, $taxonomy = 'glossary-categories') {
...
//		$terms = wp_get_post_terms( $glossary_item->ID, 'glossary-categories' );
    ...
    public static function addDisablesFields($post) {
        ...
        echo '<div class="cmtt_disables_fields_metabox">';
        echo '<label for="glossary_not_include_in_related_articles" class="blocklabel">';
...
//									$isCurrentCategory	 = ( is_numeric( $currentCategory ) && $currentCategory == $cat->term_id || $currentCategory == $cat->name );
     ...
     * @return string
     */
    public static function addAbbreviationsToGlossaryIndex($glossariIndexContentArr, $glossaryItem, $preItemTitleContent, $postItemTitleContent, $shortcodeAtts) {
...
//			$glossaryIndex	 = $query->query( $args );
     ...
     * @return string
     */
    public static function addCategory($title = '', $glossaryItem = null) {
        if (get_option('cmtt_showCategoryBeforeTitleOnIndex', 0) && $glossaryItem) {
...
' . __('Preview:', 'cm-tooltip-glossary') . ' <span id="cmtt_term_icon_preview" class="dashicons ' . esc_attr($selectedIcon) . '"></span></span></label></div><br>';
    ...
    public static function addOptions() {
        ...
        add_option('cmtt_tooltipFontStyle', 'default (disables Google Fonts)');
