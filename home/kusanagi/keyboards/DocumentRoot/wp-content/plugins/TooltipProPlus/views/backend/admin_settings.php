...
<form method="post">
    ...
    <div id="cmtt_tabs" class="glossarySettingsTabs">
            ...
            <div class="block">
                ...
                <table class="floated-form-table form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td colspan="2" class="cmtt_field_help_container">Select this option if you want to only highlight the first occurrence of each term on a page/post.</td>
                    </tr>
                    <tr valign="top">
        ...
        <div id="tabs-2">
                ...
                <table class="floated-form-table form-table">
                    <tr valign="top">
                        ...
                        <td><select name="cmtt_glossaryDisplayStyle">
                                ...
                                <optgroup label="With definition">
                                    ...
                                    <option value="expand2-style" <?php selected('expand2-style', get_option('cmtt_glossaryDisplayStyle')); ?>>Expand + description v2</option>
                                </optgroup>
                            </select><br />
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="cmtt_showCategoryBeforeTitleOnIndex" <?php checked(1, get_option('cmtt_showCategoryBeforeTitleOnIndex', 0)); ?> value="1" />
                        </td>
                        <td colspan="2" class="cmtt_field_help_container">
                            Select this option if you want to display the category names before the term name on the Glossary Index
                        </td>
                    </tr>
                </table>
            </div>
            <div class="block">
                <h3>Definition</h3>
                <p><i>All of these settings work only on the <strong>Display styles</strong> from the group "With definition"</i></p>
                <table class="floated-form-table form-table">
                    <tr valign="top">
                        <th scope="row">Display excerpt instead of description?</th>
                        <td>
                            <input type="hidden" name="cmtt_glossaryShowExcerpt" value="0" />
                            <input type="checkbox" name="cmtt_glossaryShowExcerpt" <?php checked(true, get_option('cmtt_glossaryShowExcerpt', 0)); ?> value="1" />
                        </td>
                        <td colspan="2" class="cmtt_field_help_container">
                            Select this option if you want to display exceprt field as definition instead of the content of glossary term.
            ...
            <div class="block">
                ...
                <table class="floated-form-table form-table">
                    <tr valign="top">
                        ...
                        <td colspan="2" class="cmtt_field_help_container">Select this option if you do not want to show links to the glossary term pages on the Glossary Index page.
                            <br/>Keep in mind that the plugin use a <strong>&lt;span&gt;</strong> tag instead of a link tag and if you are using a custom CSS you should take this into account</td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td colspan="2" class="cmtt_field_help_container">Select this option if you wish for the links in the Glossary Index page to be styled differently than the regular way glossary terms links are styled.
                            <br/>By selecting this option you will be able to use the class 'glossaryLinkMain' to style only the links on the Glossary Index page otherwise they will retain the class 'glossaryLink' and will be identical to the linked terms on all other pages.</td>
                    </tr>
                    <tr valign="top">
