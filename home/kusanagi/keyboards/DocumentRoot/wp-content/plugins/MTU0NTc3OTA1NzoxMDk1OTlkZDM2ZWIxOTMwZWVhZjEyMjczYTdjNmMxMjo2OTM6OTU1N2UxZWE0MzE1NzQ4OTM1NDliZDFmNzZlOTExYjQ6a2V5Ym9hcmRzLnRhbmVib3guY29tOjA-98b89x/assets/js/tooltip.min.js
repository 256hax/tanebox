...
"auto",a.style.left=e+"px",a.style.right=null),g=jQuery(window).height(),k=jQuery(window).scrollTop(),g=k+g,n=c,m=n+l,jQuery("#wpadminbar").length&&(k+=jQuery("#wpadminbar").height()),m>g&&(c-=m-g+1),n<k&&(c=d?c+(l+20):c+(k-n+1)),a.style.top=c+"px";b.clickable&&(document.onmousemove=null);CM_Tools.Modernizr.touch&&(document.onmousemove=null)},fade:function(c){var d=p;a.setAttribute("aria-hidden",!0);if(d!==b.endalpha&&1===c||0!==d&&-1===c){var f=b.speed;b.endalpha-d<b.speed&&1===c?f=b.endalpha-d:
p<b.speed&&-1===c&&(f=d);p=d+f*c;a.style.opacity=.01*p;a.style.filter="alpha(opacity="+p+")"}else clearInterval(a.timer),-1===c&&(a.style.display="none")},hide:function(){a.setAttribute("aria-hidden",!0);if("center_flip"==b.tooltipDisplayanimation||"center_flip"==b.tooltipHideanimation)jQuery("#tt").hasClass("no-out")?jQuery("#tt").addClass("temp"):jQuery("#tt").addClass("out"),jQuery("#tt").removeClass("in");jQuery(a).removeClass("flipInY");jQuery(a).removeClass("zoomIn");jQuery(a).removeClass("fadeIn");
...
b.tooltipHideanimation&&jQuery(a).stop().fadeOut(a.timer).fadeTo(0,0).css("top","-9999px").css("left","-9999px")}}},glossaryTip:null};
